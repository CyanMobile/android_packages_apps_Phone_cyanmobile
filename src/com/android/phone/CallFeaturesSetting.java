...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private static final String BUTTON_RESPOND_VIA_SMS   = "button_respond_via_sms";
    ...
    private CheckBoxPreference mButtonRejectSms;
    static boolean OktoReject;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSubMenuVoicemailSettings) {
            ...
            return true;
        } else if (preference == mButtonRejectSms) {
            return true;
...
//====
    ...
    protected void onResume() {
        ...
        if (isAirplaneModeOn()) {
            ...
            if (mButtonNotifications != null) mButtonNotifications.setEnabled(false);
    ...
    private void init(Context context, SharedPreferences pref) {
        ...
        OktoReject = pref.getBoolean(BUTTON_RESPOND_VIA_SMS, true);
    ...
    protected void onStop() {
        ...
        outState.putBoolean(BUTTON_RESPOND_VIA_SMS, mButtonRejectSms.isChecked());
