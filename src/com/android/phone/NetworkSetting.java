...
public class NetworkSetting extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        String mDevice = SystemProperties.get("ro.telephony.ril_class");
        if ("samsung".equals(mDevice) && cm.getMobileDataEnabled()) {
        alertDialog = new AlertDialog.Builder(this).create();
        alertDialog.setTitle("CyanMobile Notice");
        alertDialog.setMessage("Mobile data will be disabled now.\n to make this option works!\n Please return to choose network operator.");
