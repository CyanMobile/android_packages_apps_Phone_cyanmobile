 ...
 */
public class PhoneApp extends Application implements AccelerometerListener.OrientationListener, CameraLight.CameraLightListener {
    ...
    /* package */ void updateWakeState() {
        ...
        if (isRinging) {
             ...
             if (proximitySensorModeEnabled()) {
                 // option enabled?
               if (Settings.System.getInt(getContentResolver(), Settings.System.FLIPPING_DOWN_MUTES_RINGER, 0) == 1) {
