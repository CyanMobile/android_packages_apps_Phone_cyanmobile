...
public class RespondViaSmsManager {
    ...
    public void showRespondViaSmsPopup(Call ringingCall) {
        ...
        if (ringingCall == null) {
            Log.i(TAG, "showRespondViaSmsPopup: null ringingCall!");
            return;
        }
        if (!ringingCall.isRinging()) {
            Log.i(TAG, "showRespondViaSmsPopup: ringingCall not ringing! state = "
        ...
        boolean NokToSend = TextUtils.isEmpty(phoneNumber);

        if (NokToSend) {
            Log.i(TAG, "showRespondViaSmsPopup: null number; bailing out...");
        ...
        boolean NotaNumber = PhoneNumberUtils.isUriNumber(phoneNumber);

        if (NotaNumber) {
            Log.i(TAG, "showRespondViaSmsPopup: null not a number; bailing out...");
            mInCallScreen.internalHangupRingingCall();
        ...
        if (presentation == Connection.PRESENTATION_RESTRICTED) {
            Log.i(TAG, "showRespondViaSmsPopup: null number restricted; bailing out...");
            mInCallScreen.internalHangupRingingCall();
