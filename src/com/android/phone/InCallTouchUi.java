...
public class InCallTouchUi extends FrameLayout
    ...
    private boolean allowRespondViaSms;
    ...
    protected void onFinishInflate() {
        ...
        // "Dial-to-answer" widget for incoming calls.
            ...
            mIncomingRotarySelectorCallWidget.setMidHandleResource(R.drawable.ic_jog_dial_voice_search);
    ...
    void updateState(CallManager cm) {
        ...
        if ((ringingCall.getState() != Call.State.IDLE)
            ...
            incomingOveride = Settings.System.getInt(mContext.getContentResolver(),
    ...
    private void smsReplyTriggered() {
        hideIncomingCallWidget();
        // ...and also prevent it from reappearing right away.
        // (This covers up a slow response from the radio; see updateState().)
        mLastIncomingCallActionTime = SystemClock.uptimeMillis();
        ...
        if (mInCallScreen != null) {
            ...
            Log.e(LOG_TAG, "smsReply trigger: mInCallScreen is null");
        }
    }
    ...
    private void updateInCallStyle() {
        ...
        int ringlockStyle = Settings.System.getInt(mContext.getContentResolver(),
                ...
                RinglockStyle.getIdByStyle(RinglockStyle.Holo));
            ...
            if (mUseRotaryInCall) {
                switch (grabbedState) {
                    ...
                    case RotarySelector.RIGHT_HANDLE_GRABBED:
                        if (mSettings.OktoReject && allowRespondViaSms) {
                            hintTextResId = R.string.rotate_to_rejectsms;
                        } else {
                ...
                case RingSelector.OnRingTriggerListener.RIGHT_RING:
                    if (mSettings.OktoReject && allowRespondViaSms) {
                        hintTextResId = R.string.slide_to_rejectsms;
                    } else {
